...
plt.plot(tau_list, opt_sens_list, ls='--', marker='x', label='Seperable $S_{opt}$', color='b')

#plt.plot(tau_list, sim_t_s_opt_list, marker='o', label='Simultaneous $t_s^{opt}$')
plt.plot(tau_list, sim_opt_sens_list, marker='o', label='Simultaneous $S_{opt}$', color='g')
