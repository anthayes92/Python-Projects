...
from learner.cv_states import two_mode_coherent, two_mode_squeezed_vac, SES, correct_global_phase
...
def optimize(ket, target_state, parameters, cutoff, reps=1000, penalty_strength=0,
    ...
    ###########################################################
    # Try a few optimization algorthims
    ###########################################################

    optimiser = tf.train.AdamOptimizer()
#    optimiser = tf.train.GradientDescentOptimizer(0.01)
#    optimiser = tf.train.RMSPropOptimizer(0.01,decay=0.9,momentum=0.0,epsilon=1e-10,use_locking=False,centered=False,name='RMSProp')
